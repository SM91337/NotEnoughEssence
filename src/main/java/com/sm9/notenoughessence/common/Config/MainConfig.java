...
public class MainConfig {
    ...
    public static void loadConfig() {
        ...
        debugMode = mainConfig.getBoolean("DebugMode", Configuration.CATEGORY_GENERAL, debugMode, "Prints debug information on hostile entity death");
        dropChance = mainConfig.getInt("DropChance", Configuration.CATEGORY_GENERAL, dropChance, 0, 100, "Drop chance for hostiles");
